...
namespace BookStore.Infrastructure.BookStore.Infrastructure.Migrations
{
    ...
    [Migration("20240308195843_removingUnnecessaryTables")]
    partial class removingUnnecessaryTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStore.Core.Entities.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStore.Core.Entities.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStore.Core.Entities.OrderDetail", b =>
                {
                    b.HasOne("BookStore.Core.Entities.OrderHeader", "OrderHeader")
                        .WithMany()
